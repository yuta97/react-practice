...
export const Header: VFC = memo(() => {
  ...
  const onClickUserManagement = useCallback(() => history.push("/home/user_managemant"), [history])
  const onClickSetting = useCallback(() => history.push("/home/setting"), [history])
  return (
    <>
    <Flex as="nav" bg="teal.500" color="center" justify="space-between" padding={{ base: 3, md: 5 }} >
